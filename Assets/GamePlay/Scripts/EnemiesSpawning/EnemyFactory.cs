...
namespace GamePlay.EnemiesSpawning
{
    public class EnemyFactory
    {
        ...
        private readonly IPlacableListHandler _placables;
        public EnemyFactory(EnemiesDatabase enemies, Grid grid, Spawners spawners, PathFindMultipliersDatabase pathFindMultipliersDatabase, IPlacableListHandler placableListHandler)
        {
            _enemies = enemies;
            _grid = grid;
            _spawners = spawners;
            _pathFindMultiplierDatabase = pathFindMultipliersDatabase;
            _placables = placableListHandler;
        }
